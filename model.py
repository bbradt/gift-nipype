...
class GICACommand(GIFTCommand):
    ...
    def _make_matlab_command(self):
        ...
        batch_file_name = os.path.join(self.inputs.out_dir, '%s_gica_batch.m' % (prefix)); 
        ...
        if isdefined(self.inputs.group_ica_type):
                commandstr.append("%% Group ICA type \n");
                commandstr.append("group_ica_type = '%s';\n" % (self.inputs.group_ica_type));
